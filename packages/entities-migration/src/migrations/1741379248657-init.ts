...
export default class Init1741379248657 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "Categories" ADD CONSTRAINT "FK_1eabf8acaf25797323ad4cecc9d" FOREIGN KEY ("parentId") REFERENCES "Categories"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "Options" ADD CONSTRAINT "FK_0360b795bbe7fdcdb0b0d5b096a" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "Variant" ADD CONSTRAINT "FK_0646ccf9ed30e9b708aced6a755" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "TagProducts" ADD CONSTRAINT "FK_79a205fc9e84ec5fcf1253f0373" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "TagProducts" ADD CONSTRAINT "FK_d7c540d88e67c98705096bcfc6d" FOREIGN KEY ("tagsId") REFERENCES "Tags"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "ProductCategories" ADD CONSTRAINT "FK_5d9d943f5b8a48c001472249c1e" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "ProductCategories" ADD CONSTRAINT "FK_e2a3f20cee70c6d1ddc5107d377" FOREIGN KEY ("categoriesId") REFERENCES "Categories"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    );
  }
