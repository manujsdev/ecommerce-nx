...
export default class Optionsvalue1741454291449 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "OptionsValue" ADD CONSTRAINT "FK_73a333465f0a95949089f6e7c0b" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "OptionsValue" ADD CONSTRAINT "FK_13da43845274075859262b73d7c" FOREIGN KEY ("optionId") REFERENCES "Options"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "OptionsValueVariant" ADD CONSTRAINT "FK_0ad45f730430ee7e1b08803d239" FOREIGN KEY ("variantId") REFERENCES "Variant"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "OptionsValueVariant" ADD CONSTRAINT "FK_88ed4c02a57ab685b007280d5fc" FOREIGN KEY ("optionsValueId") REFERENCES "OptionsValue"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    );
  }
